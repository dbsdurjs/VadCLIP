...
python src/xd_test.py --model-path '../vadclip_pth/model/model_xd_caption(idea66).pth' --checkpoint-path '../vadclip_pth/model/checkpoint_caption(idea66).pth' --using-caption
