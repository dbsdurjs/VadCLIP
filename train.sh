...
python src/ucf_train.py --model-path='../vadclip_pth/model/model_ucf_caption(idea6-3).pth' --checkpoint-path='../vadclip_pth/model/checkpoint_caption(idea6-3).pth' --using-caption
python src/ucf_test.py --model-path '../vadclip_pth/model/model_ucf_caption(idea6-3).pth' --checkpoint-path '../vadclip_pth/model/checkpoint_caption(idea6-3).pth' --using-caption