...
SAVE_DIR         = '../VAD_dataset/XD-Violence/refine_description/xd_output_refine_1'
SAVE_DIR_META         = '../VAD_dataset/XD-Violence/refine_description/xd_meta_refine_1'
...
def key_xd(path: str) -> str:
    """
    XD-Violence 매칭 키:
      - 이미지: ...__0.npy, __1.npy → 뒤의 '__숫자' 제거
      - 캡션 : ..._captions_janus_pro.npy → '_captions...' 이후 제거
    예)
      Bad.Boys.1995__#00-26-51_00-27-53_label_B2-0-0__0.npy
        -> Bad.Boys.1995__#00-26-51_00-27-53_label_B2-0-0
      Bad.Boys.1995__#00-26-51_00-27-53_label_B2-0-0_captions_janus_pro.npy
        -> Bad.Boys.1995__#00-26-51_00-27-53_label_B2-0-0
    """
    stem = os.path.splitext(os.path.basename(path))[0]
    stem = re.sub(r'__\d+$', '', stem)           # 이미지 꼬리 제거
    stem = re.sub(r'_captions.*$', '', stem)     # 캡션 꼬리 제거
    return stem
...
def run_softmatch_with_x264_key(
    ...
    for img_p in img_paths:
        ...
        try:
            ...
            stem_img = stem_without_ext(img_p)
