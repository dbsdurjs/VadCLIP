...
if __name__ == '__main__':
    ...
    parser.add_argument('--root-dir', help='caption dir')
    parser.add_argument('--output-dir', help='json dir')

    args = parser.parse_args()

    # root_text_dir = '../VAD_dataset/XD-Violence/captions/clean'
    # output_dir = '../VAD_dataset/XD-Violence/xdclip_caption_feature(clean)'
    root_text_dir = args.root_dir
