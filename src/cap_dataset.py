...
class FrameDataset(Dataset):
    def __init__(self, base_folder, processor):
        ...
        classes_names = classes_names   # 클래스 8개 작업 or 전체 작업
        ...
        for class_name in os.listdir(base_folder):
            ...
            video_folders = sorted(os.listdir(class_path))[:10]  # 각 클래스 당 10개의 동영상 작업
...
def delete_existing_files(base_folder):
    ...
    classes_names = os.listdir(base_folder) # 사용 클래스 개수 설정
