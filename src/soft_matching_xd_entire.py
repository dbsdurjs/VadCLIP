...
IMAGE_CSV_PATH   = 'list/xd_CLIP_rgb.csv'
CAPTION_CSV_PATH = 'list/xd_CLIP_rgb_description.csv'
SAVE_DIR         = '../VAD_dataset/XD-Violence/refine_description/xd_output_refine_2'
SAVE_DIR_META         = '../VAD_dataset/XD-Violence/refine_description/xd_meta_refine_2'
...
def run_softmatch_with_x264_key(
    ...
    for img_p in img_paths:
        ...
        try:
            ...
            np.save(os.path.join(save_dir, f"{stem_img}_refine_2.npy"),
