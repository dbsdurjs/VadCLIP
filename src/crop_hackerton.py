...
if __name__ == '__main__':
    ...
    base_path = "../hackerton2-1/videos" # '/home/yeogeon/YG_main/diffusion_model/VAD_dataset/UCF-Crimes/UCF_Crimes/Videos'

    # 2. 추출된 프레임을 이미지 파일로 저장할 경로 (각 클래스별 폴더 생성)
    frames_output_base = "../hackerton2-1/extracted_frames" #'/home/yeogeon/YG_main/diffusion_model/VAD_dataset/UCF-Crimes/UCF_Crimes/Extracted_Frames'
    ...
    for video_name in os.listdir(base_path):
        ...
        frames_class_dir = os.path.join(frames_output_base, video_name)
