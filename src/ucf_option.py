...
parser.add_argument('--train-cap-list', default='list/ucf_CLIP_rgb_description_v2.csv')
parser.add_argument('--test-cap-list', default='list/ucf_CLIP_rgbtest_description_v2.csv')
