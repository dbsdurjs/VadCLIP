...
parser.add_argument('--train-cap-list', default='list/ucf_CLIP_rgb_caption(clean).csv')
parser.add_argument('--test-cap-list', default='list/ucf_CLIP_rgbtest_caption(clean).csv')
