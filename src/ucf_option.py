...
parser.add_argument('--lstm-layer', default=1, type=int)
...
parser.add_argument('--train-cap-list', default='list/ucf_CLIP_rgb_sbert_description.csv')
parser.add_argument('--test-cap-list', default='list/ucf_CLIP_rgbtest_sbert_description.csv')
