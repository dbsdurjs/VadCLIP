...
parser.add_argument('--text-layers', default=1, type=int) # xd에서는 1일때가 가장 좋음(or 2), 사용안함 
parser.add_argument('--text-dim', default=512, type=int) # 사용안함
parser.add_argument('--text-head', default=1, type=int) # 1일때가 가장 좋음(1,2,4,8 중 별 차이 없긴함), head는 text dim으로 나누어떨어져야 함, 사용안함
